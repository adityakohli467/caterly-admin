          ...
          <Card className="border border-gray-200 shadow-sm bg-white p-6">
                ...
                <tbody>
                  {products.map((product: any, idx: number) => (
                    <tr key={idx} className="border-b border-gray-100">
                      ...
                      <td className="px-4 py-4 text-sm text-gray-900 font-medium" style={{ fontFamily: 'Albert Sans' }}>${parseFloat(product.total || 0).toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="mt-6 space-y-3 border-t border-gray-200 pt-4">
              ...
              <div className="flex justify-end gap-32">
                ...
                <span className="text-sm text-gray-900 font-medium" style={{ fontFamily: 'Albert Sans' }}>
                  ${parseFloat(subscription.delivery_fee || 0).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-end gap-32">
            ...
            {subscription.sent_to_customer && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-xs text-green-600" style={{ fontFamily: 'Albert Sans' }}>
                  ✓ Sent to customer on {subscription.sent_to_customer_at ? formatDate(subscription.sent_to_customer_at) : 'N/A'}
                </p>
              </div>
            )}
          </Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-sm text-gray-700" style={{ fontFamily: 'Albert Sans' }}>
                    {subscription.delivery_date_time ? formatDate(subscription.delivery_date_time) : 'Not set'}
                  </p>
                )}
              </div>
